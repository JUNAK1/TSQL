...
MIS_ANIOS  		   JOB_YEARS.YEARSMI_DIASLABORADOS%TYPE:= 0; -- ANIOS LABORADOS A LA FECHA
...
MI_RETEFTE         JOBS.MAX_SALARY%TYPE:= 0; -- DESCUENTO POR RETEFTE
MI_PRIMA           JOB_GRADES.HIGHEST_SAL%TYPE:= 0; --
MI_AA              PARAMETROS2.VALOR%TYPE:= 0; --
MI_AT              PARAMETROS2.VALOR%TYPE:= 0; --
MI_DEVENGADO       JOB_GRADES.HIGHEST_SAL%TYPE:= 0;
